...
hal::bsp_pins!(
    ...
    Gpio16 {
        name: led_green,
        aliases: {
            FunctionPwm, PullNone: LedGreenPwm,
            FunctionSioOutput, PullDown: LedGreen
        }
    },
    Gpio17 {
        name: led_red,
        aliases: {
            FunctionPwm, PullNone: LedRedPwm,
            FunctionSioOutput, PullDown: LedRed
        }
    },
    Gpio25 {
        name: led_blue,
        aliases: {
            FunctionPwm, PullNone: LedBluePwm,
            FunctionSioOutput, PullDown: LedBlue
        }
    },
    Gpio26 { name: a0 },
    Gpio27 { name: a1 },
